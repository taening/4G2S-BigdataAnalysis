from src.mapAPI.v2.transform_v2 import JibunToCoordinate
import pandas as pd
...
if __name__ == '__main__':
    ...
    # Series type data
    data_c = pd.Series(['서울특별시 종로구 명륜1가 36-27', '서울특별시 종로구 명륜1가 36-23'])
    ...
    print(result_google_a)
    print(result_google_b)
    print(result_google_c)
    ...
    print(result_naver_a)
    print(result_naver_b)
    print(result_naver_c)
