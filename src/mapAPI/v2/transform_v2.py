...
class CoordinateToManhattan:
    ...
    """
    def __init__(self):
        self.__data_path = os.path.join(os.getcwd(), 'data', 'raw_data')
        self.__bus = pd.read_excel(os.path.join(self.__data_path, '2018버스정류장.xlsx'), engine='openpyxl')
        self.__crosswalk = pd.read_excel(os.path.join(self.__data_path, '2018횡단보도.xlsx'), engine='openpyxl')
        self.__subway = pd.read_excel(os.path.join(self.__data_path, '2018지하철.xlsx'), engine='openpyxl')
        self.__population = pd.read_excel(os.path.join(self.__data_path, '2018유동인구.xlsx'), engine='openpyxl')
